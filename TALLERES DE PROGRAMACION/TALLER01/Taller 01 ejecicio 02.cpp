...
void imprimir_datos(){
	...
	//En esta funcion se crea un fichero para almacenar los datos y luego imprimirlos en el fichero
	...
	//Se utiliza condicional sobre el fichero para imprimir datos
